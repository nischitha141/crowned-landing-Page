...
const index = () => {
  return (
    <div className="my-10 p-6 flex flex-col items-center justify-center gap-8 mt-[10px] relative">
      ...
      <div className="md:hidden flex flex-col items-center gap-6 w-full px-4">
        <div className="w-full border-8 border-[#F8A80D] rounded-2xl text-[#FAFAFA] bg-gradient-to-tl from-[#583A73] to-[#8459AB] flex flex-col items-start justify-start gap-2 p-4">
        ...
        <div className="w-full border-8 border-[#F8A80D] rounded-2xl text-[#FAFAFA] p-4 bg-gradient-to-tl from-[#583A73] to-[#8459AB] flex flex-col items-start justify-start gap-4">
          <p className="font-jakarta font-extrabold text-[13px]">
            💡 Genius Mind
          </p>
          <p className="font-sans font-[700] text-[11px]">
