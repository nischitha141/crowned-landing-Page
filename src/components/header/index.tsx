    ...
    <div className=" pb-[1px] rounded-lg bg-gradient-to-r from-white via-80% via-[#FDE6D4] to-[#FFC2E9]">
      <div className="flex items-center justify-between py-10 pt-12 border-transparent px-3 bg-[#FFFAF1] ">
        ...
        <div className="flex items-center gap-5 font-sans text-[#212121] text-lg font-[900]">
          <button onClick={() => scrollToSection("section-two")} className="cursor-pointer">
            About
          </button>
          <button onClick={() => scrollToSection("section-three")} className="cursor-pointer">
            How it Works
          </button>
          <button onClick={() => scrollToSection("section-four")} className="cursor-pointer">
            Rewards
          </button>
          <button onClick={() => scrollToSection("section-five")} className="cursor-pointer">
            Crown Cam
          </button>
