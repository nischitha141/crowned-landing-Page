...
const index = () => {
  ...
  return (
    <div className="my-5 md:my-12 flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-5 bg-[#F0EBF5] p-6 md:p-10 relative z-30 pointer-events-auto">
      {/* Logo Section */}
