...
const index = () => {
  ...
  return (
    <div
      id="section-five"
      className="my-8 sm:my-12 lg:my-16 xl:my-20 mx-4 sm:mx-6 lg:mx-10 xl:mx-20 mt-0 p-4 sm:p-6 lg:p-10 xl:p-14 py-8 sm:py-12 lg:py-16 xl:py-24 bg-[#AA7105] text-white flex flex-col items-center justify-center gap-4 sm:gap-6 lg:gap-8 xl:gap-10 relative"
    >
