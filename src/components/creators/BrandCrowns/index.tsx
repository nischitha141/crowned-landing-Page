...
const BrandCrowns = () => {
  ...
  const {
    ...
    handleMouseEnter,
    handleMouseLeave,
  } = useInfiniteScroll(brandCards.length);
          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M14.9591 0.633874C15.4099 0.194894 16.1407 0.194894 16.5915 0.633874L23.5171 7.37834C23.9679 7.81732 23.9679 8.52905 23.5171 8.96803L16.5915 15.7125C16.1407 16.1515 15.4099 16.1515 14.9591 15.7125C14.5083 15.2735 14.5083 14.5618 14.9591 14.1228L19.9143 9.29726H1.92407C1.28658 9.29726 0.7698 8.794 0.769801 8.17318C0.769801 7.55237 1.28659 7.04911 1.92407 7.04911L19.9143 7.04911L14.9591 2.22356C14.5083 1.78458 14.5083 1.07285 14.9591 0.633874Z"
                fill="#583A73"
              />
            </svg>
          </button>
