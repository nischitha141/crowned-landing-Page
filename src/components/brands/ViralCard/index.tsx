            ...
            >
              ...
              <div className="relative z-10 flex flex-col gap-4 sm:gap-6 lg:gap-8">
                ...
                <div className="flex items-center justify-between gap-2 sm:gap-4 relative">
                  ...
                  >
                    <div
                      className="absolute w-full text-center text-[#6d498c] font-syne text-[120px] sm:text-[180px] lg:text-[220px] font-[400] -top-[50px] sm:-top-[100px] lg:-top-[130px]"
                    >
                      {card.number}
                    </div>
                  ...
                  <p
                    className={`w-full font-sans text-[#212121] font-[600] text-sm sm:text-base lg:text-[16px] leading-relaxed ${
