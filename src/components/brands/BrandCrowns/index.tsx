    ...
    <div className="mx-4 sm:mx-8 lg:mx-20 my-8 sm:my-12 lg:my-20">
      ...
      >
        {brandCards.map((card, index) => (
          ...
          >
            <div className="z-50 text-[#424242] py-4 px-4 sm:py-4 sm:px-6 lg:py-6 lg:px-8 font-jakarta text-base sm:text-lg lg:text-xl font-[800] bg-white rounded-xl sm:rounded-2xl w-full h-full flex items-center justify-center text-center min-h-[100px] sm:min-h-[120px]">
              {card.text}
            </div>
          </div>
        ))}
